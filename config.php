...
$THEME->scss = function($theme) {
    return theme_gexcon_get_main_scss_content($theme);
};

$THEME->precompiledcsscallback = 'theme_gexcon_get_precompiled_css';
...
$THEME->layouts = array(
    ...
    'course' => array(
        'file' => 'columns2.php', // Or whichever layout you're using.
